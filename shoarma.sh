#!/usr/bin/env bash
### Created by Peter Forret ( pforret ) on 2022-02-05
...
readonly script_created="2022-02-05"
...
main() {
  ...
  case $action in
  generate)
    #TIP: use «$script_prefix generate» to ...
    #TIP:> $script_prefix generate input.txt
    do_generate
    ;;
...
show_usage() {
  ...
  out "Description: Create .md files from folder(s) of images"
